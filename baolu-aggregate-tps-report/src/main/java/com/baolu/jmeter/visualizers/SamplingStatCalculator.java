...
public class SamplingStatCalculator {
    ...
    /**
     * calcTps 是否将聚合报告采样数据统计TPS
     */
    private boolean calcTps;
    ...
    /**
     * 新增SamplingStatCalculator 构造器
     * @author libaolu
     * @param label
     * @param calcTps
     */
    public SamplingStatCalculator(String label , boolean calcTps) {
        this.label = label;
    ...
    public Sample addSample(SampleResult res) {
        ...
        synchronized (calculator) {
            ...
            if (calcTps){
                throughput = (((double) calculator.getCount()-(double) eCount) / (double) howLongRunning) * 1000.0;
            }else {
